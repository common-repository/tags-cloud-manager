<?php
  ...
  $edit_tcm_style = $border = $edit_tcm_count = 0;
...
/*
    ...
    $edit_shortcode = '[tcm id="'.$temp_option_name[0].'" title="true" taxonomy="'.$edit_get_option['tcm_taxonomy'].'"]';
    ...
    if( $edit_tcm_style == 1 ){
      ...
      $edit_tcm_text_color = ($edit_get_option['tcm_text_color']) ? $edit_get_option['tcm_text_color'] : '#007bff';
      $edit_tcm_text_hover_color = ($edit_get_option['tcm_text_hover_color']) ? $edit_get_option['tcm_text_hover_color'] : '#0056b3';
...
<div class="wrap tcm-custom">
  <h1 class="wp-heading-inline">
    ...
    ?>
    <a href="?page=tcm_add_new" class="page-title-action">Add New</a>
  </h1>
        ...
        <div id="submitdiv" class="">
          <div class="inside">
            <div class="submitbox" id="submitpost">
              <div id="major-publishing-actions" class="tcm-tablinks">
                <button class="tablinks" onclick="openTab(event, 'Create')" id="defaultOpen">Cloud Creation</button>
                <button class="tablinks" onclick="openTab(event, 'Design')">Cloud Designing</button>
              </div>
            </div>
          </div>
        </div>
...
<!-- 1st row -->
                      ...
                      <div class="submitbox" id="submitpost">
                        <div id="major-publishing-actions">
                          <div id="publishing-action">
                            ...
                            ?>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-order-by" id="tcm-name" type="radio" value="name" Required>Name <br/>
                            ...
                            ?>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-order-by" id="tcm-name" type="radio" value="name" Required Checked>Name <br/>
                          ...
                          <div id="publishing-action">
                            ...
                            <?php
                              if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit'){
                                if( $edit_tcm_count == '1' ){
                            ?>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-show-count" id="tcm-show-count-on" type="radio" value="1" required Checked>on<br/>
                            ...
                            ?>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-show-count" id="tcm-show-count-on" type="radio" value="1" required>on<br/>
                      ...
                      <div class="submitbox" id="submitpost">
                        <div id="major-publishing-actions">
                          <div id="publishing-action">
                            ...
                            ?>
                                  &nbsp;&nbsp;<input class="tcm-form" name="tcm-format" id="tcm-flat" type="radio" value="flat" Required>Flat<br/>
                            ...
                            ?>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-format" id="tcm-flat" type="radio" value="flat" Required Checked>Flat<br/>
                      ...
                      <div class="submitbox" id="submitpost">
                        <div id="major-publishing-actions">
                          <div id="publishing-action">
                            ...
                            ?>
                                  &nbsp;&nbsp;<input class="tcm-form" name="tcm-link" id="tcm-view" type="radio" value="view" Required>View <br/>
                            ...
                            ?>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-link" id="tcm-view" type="radio" value="view" Required Checked>View <br/>
                      ...
                      <div class="submitbox" id="submitpost">
                        <div id="major-publishing-actions">
                          <div id="publishing-action">
                            ...
                            ?>
                                  &nbsp;&nbsp;<input class="tcm-form" name="tcm-order" id="tcm-asc" type="radio" value="ASC" Required>ASC <br/>
                                  &nbsp;&nbsp;<input class="tcm-form" name="tcm-order" id="tcm-desc" type="radio" value="DESC" required Checked>DESC <br/>
                            ...
                            ?>
                                  &nbsp;&nbsp;<input class="tcm-form" name="tcm-order" id="tcm-asc" type="radio" value="ASC" Required>ASC <br/>
                                  &nbsp;&nbsp;<input class="tcm-form" name="tcm-order" id="tcm-desc" type="radio" value="DESC" required>DESC <br/>
                          ...
                          ?>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-order" id="tcm-asc" type="radio" value="ASC" Required Checked>ASC <br/>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-order" id="tcm-desc" type="radio" value="DESC" required>DESC <br/>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-order" id="tcm-rand" type="radio" value="RAND" required>RAND 
                            <?php
                              }
                          ...
                          <div id="publishing-action">
                            ...
                            <?php
                              if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit'){
                                if( $edit_tcm_unit == 'px' ){
                            ?>
                                  &nbsp;&nbsp;<input class="tcm-form" name="tcm-measure" id="tcm-pt-measure" type="radio" value="pt" Required>pt&nbsp;(Points)<br/>
                            ...
                            ?>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-measure" id="tcm-pt-measure" type="radio" value="pt" Required Checked>pt&nbsp;(Points)<br/>
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-measure" id="tcm-px-measure" type="radio" value="px" required>px&nbsp;(Pixels)
        ...
        <!-- /post-body-content -->
        <div id="postbox-container-1" class="postbox-container tcm-simple-style" style="<?php echo ($edit_tcm_style == 0) ? 'display: block' : 'display: none'; ?>">
          <div id="side-sortables" class="meta-box-sortables ui-sortable" style="">
            <div class="tcm-add row">
              <div class="col-sm-7 tcm-post-type" style="display:<?php echo ( isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit' ) ? 'block' : 'none' ; ?>">
                <div id="submitdiv" class="postbox ">
                  <div class="inside">
                    <div class="submitbox" id="submitpost">
                      <div id="major-publishing-actions">
            ...
            <div class="tcm-add row" >
              <div class="col-sm-12">
                <div id="submitdiv" class="tcm_cloud_content">
                  <h2 class="hndle ui-sortable-handle">
                    <span>Preview</span>
                  </h2>

                  <div class="tcm-preview-flat" style="<?php echo ($edit_tcm_format == 'flat') ? 'display:block' : 'display:none'; ?>">
                      <a href="#" class="tag-cloud-link tag-link-0 tag-link-position-1" style="font-size: 12pt;" aria-label="Tag-1 (2 items)">Tag-1<span class="tag-link-count" style="<?php echo( $edit_tcm_count == 1 ) ? 'display:initial' : 'display:none'; ?>"> (2)</span></a>

                      <a href="#" class="tcm_separator" style="<?php echo ($edit_tcm_separator_check == 'on' && $edit_tcm_separator) ? 'display:block' : 'display:none'; ?>"><?php echo $edit_tcm_separator; ?></a>

                      <a href="#" class="tag-cloud-link tag-link-0 tag-link-position-1" style="font-size: 13pt;" aria-label="TagTag-2 (3 items)">TagTag-2<span class="tag-link-count" style="<?php echo( $edit_tcm_count == 1 ) ? 'display:initial' : 'display:none'; ?>"> (2)</span></a>

                      <a href="#" class="tcm_separator" style="<?php echo ($edit_tcm_separator_check == 'on' && $edit_tcm_separator) ? 'display:block' : 'display:none'; ?>"><?php echo $edit_tcm_separator; ?></a>

                      <a href="#" class="tag-cloud-link tag-link-0 tag-link-position-1" style="font-size: 12pt;" aria-label="TagTagTag-3 (2 items)">TagTagTag-3<span class="tag-link-count" style="<?php echo( $edit_tcm_count == 1 ) ? 'display:initial' : 'display:none'; ?>"> (2)</span></a>
                    
                      <a href="#" class="tcm_separator" style="<?php echo ($edit_tcm_separator_check == 'on' && $edit_tcm_separator) ? 'display:block' : 'display:none'; ?>"><?php echo $edit_tcm_separator; ?></a>

                      <a href="#" class="tag-cloud-link tag-link-0 tag-link-position-1" style="font-size: 14pt;" aria-label="Tag-6 (4 items)">Tag-6<span class="tag-link-count" style="<?php echo( $edit_tcm_count == 1 ) ? 'display:initial' : 'display:none'; ?>"> (2)</span></a>

                      <a href="#" class="tcm_separator" style="<?php echo ($edit_tcm_separator_check == 'on' && $edit_tcm_separator) ? 'display:block' : 'display:none'; ?>"><?php echo $edit_tcm_separator; ?></a>

                      <a href="#" class="tag-cloud-link tag-link-1 tag-link-position-2" style="font-size: 16pt;" aria-label="Uncategorized (6 items)">Uncategorized<span class="tag-link-count" style="<?php echo( $edit_tcm_count == 1 ) ? 'display:initial' : 'display:none'; ?>"> (6)</span></a>
                  </div>

                  <div class="tcm-preview-list" style="<?php echo ($edit_tcm_format == 'list') ? 'display:block' : 'display:none'; ?>">
    ...
    <div id="poststuff">
      <div id="post-body" class="metabox-holder columns-2">
        <div id="post-body-content" style="position: relative;">
          <div id="titlewrap" class="tcm-add">
            <div class="row">
                        ...
                        <div id="publishing-action">
                          ...
                          <?php
                            if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit'){
                              if($edit_tcm_style == 1){
                          ?>
                                <input class="tcm-form" name="tcm-styles" id="tcm-styles-simple" type="radio" value="0" required>Simple
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-styles" id="tcm-styles-custom" type="radio" value="1" Required Checked>Custom
                          <?php
                              }else{
                          ?>
                                <input class="tcm-form" name="tcm-styles" id="tcm-styles-simple" type="radio" value="0" required Checked>Simple Style
                                &nbsp;&nbsp;<input class="tcm-form" name="tcm-styles" id="tcm-styles-custom" type="radio" value="1" Required>Custom
                          <?php
                              }
                            }else{
                          ?>
                              <input class="tcm-form" name="tcm-styles" id="tcm-styles-simple" type="radio" value="0" required Checked>Simple
                              &nbsp;&nbsp;<input class="tcm-form" name="tcm-styles" id="tcm-styles-custom" type="radio" value="1" Required>Custom
                          <?php
                            }
                          ?>
              ...
              <div class="tcm-custom-style col-sm-8" style=" <?php echo ($edit_tcm_style == 0) ? 'display: none' : 'display: block'; ?>">
                <div id="submitdiv" class="postbox ">
                  <div class="inside">
                    <div class="submitbox" id="submitpost">
                      <div id="major-publishing-actions">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-4">
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <input class="tcm-form" name="tcm-text-color" id="tcm-text-color" type="color" value="<?php echo ( isset($edit_tcm_text_color) && $edit_tcm_text_color ) ? $edit_tcm_text_color : '#007bff'; ?>" placeholder="Color" title="Text Color">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <input class="tcm-form" name="tcm-text-hover-color" id="tcm-text-hover-color" type="color" value="<?php echo ( isset($edit_tcm_text_hover_color) && $edit_tcm_text_hover_color ) ? $edit_tcm_text_hover_color : '#0056b3'; ?>" placeholder="Color" title="Text Hover Color">
                                </div>
                              </div>
                            </div>
          ...
          <div id="titlewrap" class="tcm-add tcm-custom-style" style="<?php echo ($edit_tcm_style == 0) ? 'display: none' : 'display: block'; ?>">
            <div class="row">
              <div class="col-sm-9">
                <div class="row">
                            ...
                            <div id="publishing-action">
                              ...
                              <div class="row">
                                <div class="col-sm-3">
                                      ...
                                      <div class="submitbox" id="submitpost">
                                        <div id="major-publishing-actions">
                                          <div id="publishing-action">
                                            <center>
                                              <span>Top </span><br/>
                                              <input class="tcm-form" title="Top Border ?" name="tcm-border-top" id="tcm-border-top" type="checkbox" <?php echo ($edit_tcm_border_top == 'on') ? 'CHECKED' : ''; ?>>
                                            </center>
                                          </div>
                                          <div class="clear"></div>
                                        </div>
                                  ...
                                  <div class="border-top" style="<?php echo ($edit_tcm_border_top != 'on') ? 'display: none' : 'display: block'; ?>">
                                    <div id="submitdiv" class="postbox border-top" style="margin-bottom:0px !important">
                                      <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                                <input class="tcm-form" name="tcm-border-width-top" id="tcm-border-width-top" type="number" placeholder="Width" title="Border Width" value="<?php echo ( isset($edit_tcm_border_width_top) && $edit_tcm_border_width_top ) ? $edit_tcm_border_width_top : 0; ?>">
                                            </div>
                                            <div class="clear"></div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <?php
                                                if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit'){
                                                  echo '<select class="tcm-form" name="tcm-border-style-top" id="tcm-border-style-top" title="Border Style">';
                                                  foreach ($border_styles as $key => $value) {
                                                    if($key == $edit_tcm_border_style_top){
                                    ...
                                    <div id="submitdiv" class="postbox border-top" style="margin-bottom:0px !important">
                                      <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <input class="tcm-form" name="tcm-border-color-top" id="tcm-border-color-top" type="color" value="<?php echo ( isset($edit_tcm_border_color_top) && $edit_tcm_border_color_top ) ? $edit_tcm_border_color_top : '#BBBBBB'; ?>" placeholder="Color" title="Border Color">
                                            </div>
                                            <div class="clear"></div>
                                          </div>
                                        </div>
                                ...
                                <div class="col-sm-3">
                                      ...
                                      <div class="submitbox" id="submitpost">
                                        <div id="major-publishing-actions">
                                          <div id="publishing-action">
                                            <center>
                                              <span>Bottom </span><br/>
                                              <input class="tcm-form" title="Bottom Border ?" name="tcm-border-bottom" id="tcm-border-bottom" type="checkbox" <?php echo ($edit_tcm_border_bottom == 'on') ? 'CHECKED' : ''; ?>>
                                            </center>
                                          </div>
                                          <div class="clear"></div>
                                        </div>
                                  ...
                                  <div class="border-bottom" style="<?php echo ($edit_tcm_border_bottom != 'on') ? 'display: none' : 'display: block'; ?>">
                                    <div id="submitdiv" class="postbox border-bottom" style="margin-bottom:0px !important">
                                      <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <input class="tcm-form" name="tcm-border-width-bottom" id="tcm-border-width-bottom" type="number" placeholder="Width" title="Border Width" value="<?php echo ( isset($edit_tcm_border_width_bottom) && $edit_tcm_border_width_bottom ) ? $edit_tcm_border_width_bottom : 0; ?>">
                                            </div>
                                            <div class="clear"></div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <?php
                                                if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit'){
                                                  echo '<select class="tcm-form" name="tcm-border-style-bottom" id="tcm-border-style-bottom" title="Border Style">';
                                                  foreach ($border_styles as $key => $value) {
                                                    if($key == $edit_tcm_border_style_bottom){
                                                      echo '<option value="'.$key.'" SELECTED>'.$value.'</option>';
                                                    }else{
                                                      echo '<option value="'.$key.'">'.$value.'</option>';
                                                    }
                                    ...
                                    <div id="submitdiv" class="postbox border-bottom" style="margin-bottom:0px !important">
                                      <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <input class="tcm-form" name="tcm-border-color-bottom" id="tcm-border-color-bottom" type="color" value="<?php echo ( isset($edit_tcm_border_color_bottom) && $edit_tcm_border_color_bottom ) ? $edit_tcm_border_color_bottom : '#BBBBBB'; ?>" placeholder="Color" title="Border Color">
                                            </div>
                                            <div class="clear"></div>
                                          </div>
                                        </div>
                                ...
                                <div class="col-sm-3">
                                      ...
                                      <div class="submitbox" id="submitpost">
                                        <div id="major-publishing-actions">
                                          <div id="publishing-action">
                                            <center>
                                              <span>Left </span><br/>
                                              <input class="tcm-form" title="Left Border ?" name="tcm-border-left" id="tcm-border-left" type="checkbox" <?php echo ($edit_tcm_border_left == 'on') ? 'CHECKED' : ''; ?>>
                                            </center>
                                          </div>
                                          <div class="clear"></div>
                                        </div>
                                  ...
                                  <div class="border-left" style="<?php echo ($edit_tcm_border_left != 'on') ? 'display: none' : 'display: block'; ?>">
                                    <div id="submitdiv" class="postbox border-left" style="margin-bottom:0px !important">
                                      <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <input class="tcm-form" name="tcm-border-width-left" id="tcm-border-width-left" type="number" placeholder="Width" title="Border Width" value="<?php echo ( isset($edit_tcm_border_width_left) && $edit_tcm_border_width_left ) ? $edit_tcm_border_width_left : 0; ?>">
                                            </div>
                                            <div class="clear"></div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <?php
                                                if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit'){
                                                  echo '<select class="tcm-form" name="tcm-border-style-left" id="tcm-border-style-left" title="Border Style">';
                                                  foreach ($border_styles as $key => $value) {
                                                    if($key == $edit_tcm_border_style_left){
                                                      echo '<option value="'.$key.'" SELECTED>'.$value.'</option>';
                                                    }else{
                                                      echo '<option value="'.$key.'">'.$value.'</option>';
                                                    }
                                    ...
                                    <div id="submitdiv" class="postbox border-left" style="margin-bottom:0px !important">
                                      <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <input class="tcm-form" name="tcm-border-color-left" id="tcm-border-color-left" type="color" value="<?php echo ( isset($edit_tcm_border_color_left) && $edit_tcm_border_color_left ) ? $edit_tcm_border_color_left : '#BBBBBB'; ?>" placeholder="Color" title="Border Color">
                                            </div>
                                            <div class="clear"></div>
                                          </div>
                                        </div>
                                ...
                                <div class="col-sm-3">
                                      ...
                                      <div class="submitbox" id="submitpost">
                                        <div id="major-publishing-actions">
                                          <div id="publishing-action">
                                            <center>
                                              <span>Right </span><br/>
                                              <input class="tcm-form" title="Right Border ?" name="tcm-border-right" id="tcm-border-right" type="checkbox" <?php echo ($edit_tcm_border_right == 'on') ? 'CHECKED' : ''; ?>>
                                            </center>
                                          </div>
                                          <div class="clear"></div>
                                        </div>
                                  ...
                                  <div class="border-right" style="<?php echo ($edit_tcm_border_right != 'on') ? 'display: none' : 'display: block'; ?>">
                                    <div id="submitdiv" class="postbox border-right" style="margin-bottom:0px !important">
                                      <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <input class="tcm-form" name="tcm-border-width-right" id="tcm-border-width-right" type="number" placeholder="Width" title="Border Width" value="<?php echo ( isset($edit_tcm_border_width_right) && $edit_tcm_border_width_right ) ? $edit_tcm_border_width_right : 0; ?>">
                                            </div>
                                            <div class="clear"></div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <?php
                                                if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit'){
                                                  echo '<select class="tcm-form" name="tcm-border-style-right" id="tcm-border-style-right" title="Border Style">';
                                                  foreach ($border_styles as $key => $value) {
                                                    if($key == $edit_tcm_border_style_right){
                                                      echo '<option value="'.$key.'" SELECTED>'.$value.'</option>';
                                                    }else{
                                                      echo '<option value="'.$key.'">'.$value.'</option>';
                                                    }
                                    ...
                                    <div id="submitdiv" class="postbox border-right" style="margin-bottom:0px !important">
                                      <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                          <div id="major-publishing-actions">
                                            <div id="publishing-action">
                                              <input class="tcm-form" name="tcm-border-color-right" id="tcm-border-color-right" type="color" value="<?php echo ( isset($edit_tcm_border_color_right) && $edit_tcm_border_color_right ) ? $edit_tcm_border_color_right : '#BBBBBB'; ?>" placeholder="Color" title="Border Color">
                                            </div>
                                            <div class="clear"></div>
                                          </div>
                                        </div>
                  ...
                  <div class="col-sm-12">
                    <dv class="row">
                      <div class="col-sm-12">
                        <div id="submitdiv" class="postbox tcm-add">
                          <div class="inside">
                            <div class="submitbox" id="submitpost">
                              <div id="major-publishing-actions">
                                <h2 class="hndle ui-sortable-handle">
              ...
              <div class="col-sm-3">
                <div class="row">
                  <div class="col-sm-12 tcm-separator-check" style="<?php echo ( isset($edit_tcm_separator) && $edit_tcm_separator ) ? 'display:block' : 'display:none'; ?>">
                    <div id="submitdiv" class="postbox ">
                      <div class="inside">
                        <div class="submitbox" id="submitpost">
                          <div id="major-publishing-actions">
                            <div id="publishing-action">
                              ...
                              <input class="tcm-form" name="tcm-separator-check" id="tcm-separator-check" type="checkbox" <?php echo ( isset($edit_tcm_separator_check) && $edit_tcm_separator_check == 'on' && $edit_tcm_separator ) ? 'Checked' : ''; ?> title="Separator Status">&nbsp;&nbsp;on/off
                              </center>
                            </div>
                            <div class="clear"></div>
                          </div>
                  ...
                  <div class="col-sm-12">
                    <div style="<?php echo ( isset($edit_tcm_separator_check) && $edit_tcm_separator_check == 'on' && $edit_tcm_separator ) ? 'display: block' : 'display: none'; ?>" class="tcm-separator-decoration">
                      <div id="submitdiv" class="postbox border">
                        <div class="inside">
                          <div class="submitbox" id="submitpost">
                            <div id="major-publishing-actions">
                              <div id="publishing-action">
                                <center>
                                <h2 class="hndle ui-sortable-handle">
                                    <span>Separator Decoration </span>
                                </h2>
                                <input class="tcm-form" name="tcm-separator-decoration" id="tcm-separator-decoration" type="checkbox" <?php echo ( isset($edit_tcm_separator_decoration) && $edit_tcm_separator_decoration == 'on' ) ? 'Checked' : ''; ?> title="Separator Decoration">
                                </center>
                              </div>
                              <div class="clear"></div>
                            </div>
                            ...
                            <div class="inside">
                              <div class="submitbox" id="submitpost">
                                <div id="major-publishing-actions">
                                  <div id="publishing-action">
                                    <h2 class="hndle ui-sortable-handle">
                                      <span><input class="tcm-form" name="tcm-text-decoration" id="tcm-text-decoration" type="checkbox" <?php echo ( isset($edit_tcm_text_decoration) && $edit_tcm_text_decoration == 'on' ) ? 'Checked' : ''; ?> title="Text Decoration">&nbsp;&nbsp;Text Decoration</span>
                                    </h2>
                                    <div class="row">                
                                      <div class="col-sm-12">
                                        <div style="<?php echo ( isset($edit_tcm_text_decoration) && $edit_tcm_text_decoration != 'on' ) ? 'display: none' : 'display: block'; ?>" class="tcm-text-decoration">
        ...
        <div id="postbox-container-1" class="postbox-container tcm-simple-style" style="<?php echo ($edit_tcm_style == 0) ? 'display: block' : 'display: none'; ?>">
          <div class="tcm-add row tcm-style-preview">
            <div class="col-sm-12">
              <div id="submitdiv" class="tcm_cloud_content">
                <h2 class="hndle ui-sortable-handle">
          ...
          <div class="tcm-add row" >
            <div class="col-sm-12" >
              <div id="submitdiv" class="postbox tcm-submit tcm-add" style="display: <?php echo $edit_tcm_btn; ?>">
                <div class="inside">
                  <div class="submitbox" id="submitpost">
                    <div id="major-publishing-actions">
                      <div id="">
                            ...
                            <div class="submitbox" id="submitpost">
                              <div id="major-publishing-actions">
                                <div id="publishing-action">
                                    ...
                                    <input class="tcm-form" name="tcm-border-radius-top-left" id="tcm-border-radius-top-left" type="number" placeholder="Top Left Readius" title="Top Left Radius" value="<?php echo ( isset($edit_tcm_border_radius_top_left) && $edit_tcm_border_radius_top_left ) ? $edit_tcm_border_radius_top_left : 0; ?>">
                                </div>
                                <div class="clear"></div>
                              </div>
                            </div>
                            ...
                            <div class="submitbox" id="submitpost">
                              <div id="major-publishing-actions">
                                <div id="publishing-action">
                                    ...
                                    <input class="tcm-form" name="tcm-border-radius-top-right" id="tcm-border-radius-top-right" type="number" placeholder="Top Right Readius" title="Top Right Radius" value="<?php echo ( isset($edit_tcm_border_radius_top_right) && $edit_tcm_border_radius_top_right ) ? $edit_tcm_border_radius_top_right : 0; ?>">
                                </div>
                                <div class="clear"></div>
                              </div>
                            </div>
                            ...
                            <div class="submitbox" id="submitpost">
                              <div id="major-publishing-actions">
                                <div id="publishing-action">
                                    ...
                                    <input class="tcm-form" name="tcm-border-radius-bottom-left" id="tcm-border-radius-bottom-left" type="number" placeholder="Bottom Left Readius" title="Bottom Left Radius" value="<?php echo ( isset($edit_tcm_border_radius_bottom_left) && $edit_tcm_border_radius_bottom_left ) ? $edit_tcm_border_radius_bottom_left : 0; ?>">
                                </div>
                                <div class="clear"></div>
                              </div>
                            </div>
                            ...
                            <div class="submitbox" id="submitpost">
                              <div id="major-publishing-actions">
                                <div id="publishing-action">
                                    ...
                                    <input class="tcm-form" name="tcm-border-radius-bottom-right" id="tcm-border-radius-bottom-right" type="number" placeholder="Bottom Right Readius" title="Bottom Right Radius" value="<?php echo ( isset($edit_tcm_border_radius_bottom_right) && $edit_tcm_border_radius_bottom_right ) ? $edit_tcm_border_radius_bottom_right : 0; ?>">
                                </div>
                                <div class="clear"></div>
                              </div>
                            </div>
