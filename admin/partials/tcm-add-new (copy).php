...
<div class="wrap tcm-custom">
  ...
  <form name="tcm_add_new_form" action="<?php echo admin_url(); ?>admin.php?page=tcm_add_new&id=<?php echo $_GET['id']; ?>" method="post" id="tcm_add_new_form">
    <div id="poststuff">
      <div id="post-body" class="metabox-holder columns-2">
        <div id="post-body-content" style="position: relative;">
          <div id="titlediv"><!-- 
            ...
            <div id="titlewrap" class="tcm-add col-sm-12">
                      ...
                      <div class="submitbox" id="submitpost">
                        <div id="major-publishing-actions">
                          <div id="publishing-action">
                            ...
                            ?>
                                <input class="tcm-form" name="tcm-exclude" id="tcm-exclude" value="<?php echo $edit_tcm_exclude; ?>" type="text" placeholder="<?php esc_html_e(' Tags Id','tcm'); ?>">
                            <?php
                              }else{
                            ?>
                                <input class="tcm-form" name="tcm-exclude" id="tcm-exclude" type="text" placeholder="<?php esc_html_e(' Tags Id','tcm'); ?>">
                            <?php
                              }
                            ?>
                          </div>
        ...
        <div id="postbox-container-1" class="postbox-container">
          <div id="side-sortables" class="meta-box-sortables ui-sortable" style="">
            <div class="tcm-add" style="float:left; width:100%;">
              ...
              <div class="tcm-submit" style="float:right; width:38%; display: <?php echo $edit_tcm_btn; ?>;">
                <div id="submitdiv" class="postbox ">
                  <div class="inside">
                    <div class="submitbox" id="submitpost">
                      <div id="major-publishing-actions">
                    ...
                    <div class="submitbox" id="submitpost">
                      <div id="major-publishing-actions">
                        <div id="publishing-action">
                          ...
                          <input class="tcm-form" name="tcm-limit" id="tcm-limit" type="number" value="<?php echo $edit_temp_link; ?>" placeholder="<?php esc_html_e(' Cloud Limit','tcm'); ?>" required>
                        </div>
                        <div class="clear"></div>
                      </div>
                    </div>
        ...
        <div id="post-body-content" style="position: relative;">
          <div id="titlewrap" class="tcm-add">
            <div style="float:left; width:100%;">
              ...
              <div class="tcm-custom-style" style="float:right; width:64%; <?php echo ($edit_tcm_style == 0) ? 'display: none' : 'display: block'; ?>">
                <div id="submitdiv" class="postbox ">
                  <h2 class="hndle ui-sortable-handle">
                              ...
                              <div id="submitdiv" class="postbox" style="margin-bottom:0px !important">
                                ...
                                <div class="inside">
                                  <div class="submitbox" id="submitpost">
                                    <div id="major-publishing-actions">
                                      <div id="publishing-action">
                                        <input class="tcm-form" title="Top Border ?" name="tcm-border-top" id="tcm-border-top" type="checkbox" <?php echo ($edit_tcm_border_top == 'on') ? 'CHECKED' : ''; ?>> Top Border
                                      </div>
                                      <div class="clear"></div>
                                    </div>
                                  </div>
                                ...
                                <div id="submitdiv" class="postbox border-top" style="margin-bottom:0px !important">
                                  <div class="inside">
                                    <div class="submitbox" id="submitpost">
                                      <div id="major-publishing-actions">
                                        <div id="publishing-action">
                                            <input class="tcm-form" name="tcm-border-color-top" id="tcm-border-color-top" type="color" value="<?php echo ( isset($edit_tcm_border_radius_top) && $edit_tcm_border_color_top ) ? $edit_tcm_border_color_top : '#BBBBBB'; ?>" placeholder="Color" title="Border Color">
                                        </div>
                                        <div class="clear"></div>
                                      </div>
                                    </div>
                              ...
                              <div id="submitdiv" class="postbox" style="margin-bottom:0px !important">
                                <div class="inside">
                                  <div class="submitbox" id="submitpost">
                                    <div id="major-publishing-actions">
                                      <div id="publishing-action">
                                        <input class="tcm-form" title="Bottom Border ?" name="tcm-border-bottom" id="tcm-border-bottom" type="checkbox" <?php echo ($edit_tcm_border_bottom == 'on') ? 'CHECKED' : ''; ?>> Bottom Border
                                      </div>
                                      <div class="clear"></div>
                                    </div>
                                  </div>
                              ...
                              <div id="submitdiv" class="postbox" style="margin-bottom:0px !important">
                                <div class="inside">
                                  <div class="submitbox" id="submitpost">
                                    <div id="major-publishing-actions">
                                      <div id="publishing-action">
                                        <input class="tcm-form" title="Left Border ?" name="tcm-border-left" id="tcm-border-left" type="checkbox" <?php echo ($edit_tcm_border_left == 'on') ? 'CHECKED' : ''; ?>> Left Border
                                      </div>
                                      <div class="clear"></div>
                                    </div>
                                  </div>
                              ...
                              <div id="submitdiv" class="postbox" style="margin-bottom:0px !important">
                                ...
                                <div class="inside">
                                  <div class="submitbox" id="submitpost">
                                    <div id="major-publishing-actions">
                                      <div id="publishing-action">
                                        <input class="tcm-form" title="Right Border ?" name="tcm-border-right" id="tcm-border-right" type="checkbox" <?php echo ($edit_tcm_border_right == 'on') ? 'CHECKED' : ''; ?>> Right Border
                                      </div>
                                      <div class="clear"></div>
                                    </div>
                                  </div>
          ...
          <div id="titlewrap" class="tcm-add tcm-custom-style" style="<?php echo ($border == '0') ? 'display:none' : 'display: block'; ?>">
            <div style="float:left; width:100%;">
